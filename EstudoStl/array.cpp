...
void test1() {
    ...
    arr1[0] = 1000; //does not do bound checking
    arr1.at(1) = 2000; // does bound checking, if it occurs an exception is thrown
    display(arr1);
...
void test5() {
    ...
    //iteradores sao acessados igualmente ponteiros, por convenção
    std::cout << *(min_num - 1) << " " << *(max_num + 1) << std::endl; // 2 e 3
...
void test6() {
    ...
    //encontra numeros repetidos que estão um ao lado do outro, apenas nessa condição
